...
private func keyDispatch(
    ...
    case (.keyDown, kVK_Tab, false, (false, true, false)): Task { await wc.doRaisePrev() }
    case (.keyDown, kVK_Tab, true, (false, true, false)): break

    case (.keyDown, kVK_Tab, false, (false, true, true)): Task { await wc.doRaiseWalk() }
    case (.keyDown, kVK_Tab, true, (false, true, true)): break

    case (.keyDown, kVK_ANSI_Grave, false, (false, true, false)): Task { await wc.doRaiseWalk() }
